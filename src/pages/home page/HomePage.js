...
// src={avatarMap[`avatar${avatarNumber}`]}
     ...
     return (
          <>
               <div className="home-page">
                    <div className="greeting-dashboard fade-in-1">
                         ...
                         <div className='flex justify-center items-center avatar-img-container'>
                              <img className='avatar-img' alt='avatar'  src={avatarMap[avatarNumber-1]}  />
                         </div>
                         ...
                         <div className="flex flex-row justify-between w-full badge-container">
                              <div className="flex flex-col badge">
                                   <div className="flex items-center gap-2">
                                        <CiCloudOn style={{ strokeWidth: 1, stroke: "currentColor"}}/>
                                        <h3 className="text-xs font-bold">Your emissions</h3>
                                   </div>
                                   <div>
                                        <span className="text-2xl font-bold pt-1 pb-0 inline-block">↓ 20%</span>
                                   </div>
                              ...
                              <div className="flex flex-col badge">
                                   <div className="flex items-center gap-2">
                                        <LuTreeDeciduous style={{ strokeWidth: 2, stroke: "currentColor"}}/>
                                        <h3 className="text-xs font-bold">Trees needed</h3>
                                   </div>
                                   <div>
                                        <span className="text-2xl font-bold pt-1 pb-0 inline-block">700</span>
                                   </div>
                    ...
                    <div className="activities-card fade-in-2">
